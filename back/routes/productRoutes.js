...
router.post('/', async(req, res)=> {
  try {
    const {barcode, name, description, price, category, images: pictures} = req.body;
    const product = await Product.create({barcode, name, description, price, category, pictures});
